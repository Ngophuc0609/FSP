...
namespace FSP.Infrastructure.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkOrderAttachments_TenantId_WorkOrderId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkOrders_TenantId_AssignedTechnicianId",
                table: "WorkOrders",
                columns: new[] { "TenantId", "AssignedTechnicianId" });

            migrationBuilder.CreateIndex(
                name: "IX_WorkOrders_TenantId_ClientReferenceId",
                table: "WorkOrders",
                columns: new[] { "TenantId", "ClientReferenceId" },
                unique: true);
